...
summary: "关于 42 步进电机的拆解图片和运行示例代码"
toc: true
---
...
本文的大部分内容来源于油管视频和 [https://lastminuteengineers.com/，如果想要动手实践，看下面两个链接足矣](https://lastminuteengineers.com/，如果想要动手实践，看下面两个链接足矣)：

* 视频：[https://www.youtube.com/watch?v=7spK_BkMJys](https://www.youtube.com/watch?v=7spK_BkMJys)
* 文章：[https://lastminuteengineers.com/a4988-stepper-motor-driver-arduino-tutorial/](https://lastminuteengineers.com/a4988-stepper-motor-driver-arduino-tutorial/)
...
[https://www.bilibili.com/video/BV1m84y1a79w/](https://www.bilibili.com/video/BV1m84y1a79w/)
...
这也就是为什么步进电机有四根引线的原因，两根引线（正负极）控制一组（4 个）线圈。
...
* [https://www.youtube.com/watch?v=eyqwLiowZiU](https://www.youtube.com/watch?v=eyqwLiowZiU)
...
[https://www.allegromicro.com/-/media/files/datasheets/a4988-datasheet.pdf](https://www.allegromicro.com/-/media/files/datasheets/a4988-datasheet.pdf)
...
16 号引脚 VMOT 和 15 号引脚 GND 是给步进电机供电用的，需要外接 8V-35V 之间的电源，另外为了保护驱动器免受电压尖峰影响，需要在电机电源引脚上放置一个 100μF 的大电解电容。

10 号引脚 VDD 和 9 号引脚 GND 负责给内部逻辑电路供电，提供 3.3V - 5V 的电压即可。
...
RST 也是低电平有效输入。当该引脚被拉低时，所有步进输入将被忽略。它还通过将内部转换器设置为预定义的“Home”状态来重置驱动进程。Home 状态基本上是电机启动的初始位置，它根据微步分辨率（细分数）而变化。
...
1. [https://lastminuteengineers.com/a4988-stepper-motor-driver-arduino-tutorial/](https://lastminuteengineers.com/a4988-stepper-motor-driver-arduino-tutorial/)
2. [https://www.youtube.com/watch?v=eyqwLiowZiU](https://www.youtube.com/watch?v=eyqwLiowZiU)
3. [https://www.youtube.com/watch?v=09Mpkjcr0bo](https://www.youtube.com/watch?v=09Mpkjcr0bo)
4. [https://www.youtube.com/watch?v=7spK_BkMJys](https://www.youtube.com/watch?v=7spK_BkMJys)
