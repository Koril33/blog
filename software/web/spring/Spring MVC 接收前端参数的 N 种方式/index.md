---
title: "Spring MVC 接收前端参数的 N 种方式"
...
面试官们见了 Spring MVC，也每每这样问他，引人发笑。Spring MVC 自己知道不能和他们谈天，便只好向孩子说话。有一回对我说道，“你写过 web 接口么？”我略略点一点头。他说，“写过接口，……我便考你一考。后端接受前端参数，怎样收的？”我想，讨饭一样的人，也配考我么？便回过脸去，不再理会。Spring MVC 等了许久，很恳切的说道，“不能写罢？……我教给你，记着！这些注解应该记着。将来做高级码农的时候，写接口要用。”我暗想我和高级码农的等级还很远呢；又好笑，又不耐烦，懒懒的答他道，“谁要你教，不就是 `@RequestMapping` 加个方法么？”Spring MVC 显出极高兴的样子，将两个指头的长指甲敲着柜台，点头说，“对呀对呀！……除了这个注解还有其他的，你知道么？”我愈不耐烦了，努着嘴走远。Spring MVC 刚用指甲蘸了酒，想在柜上写字，见我毫不热心，便又叹一口气，显出极惋惜的样子。

就像是茴香豆的茴字有四种写法一样，工作里前后端接口对接，总的来说都是通过 HTTP 协议，前端传递字符串或者特定格式（比如 JSON 或者 XML）的信息，后端如果用的是 Spring MVC 框架，一般会用到一些注解，本文简单的记录下工作里常用的一些方式，做个备忘。
...
路径作为参数，比如：[http://myblog/post/123，这里](http://myblog/post/123，这里) post 和 123 作为路径参数来查询信息，这时候用 `@PathVariable` 映射即可：
...
* [https://www.baeldung.com/postman-form-data-raw-x-www-form-urlencoded](https://www.baeldung.com/postman-form-data-raw-x-www-form-urlencoded)
* [https://stackoverflow.com/questions/26723467/postman-chrome-what-is-the-difference-between-form-data-x-www-form-urlencoded](https://stackoverflow.com/questions/26723467/postman-chrome-what-is-the-difference-between-form-data-x-www-form-urlencoded)
