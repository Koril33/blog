...
#### 彩虹表攻击
彩虹表是一种预先计算好的哈希值与其对应的明文密码的查找表。该方法的缺点是占用磁盘空间大，主流彩虹表都是上百 GB。
...
2. salt 需要足够长，一般至少 128 位（16 字节）以上。
...
1. [https://www.cnblogs.com/makai/p/11130703.html](https://www.cnblogs.com/makai/p/11130703.html)
2. [https://crackstation.net/hashing-security.htm](https://crackstation.net/hashing-security.htm)
3. [https://www.cmd5.com/default.aspx](https://www.cmd5.com/default.aspx)
