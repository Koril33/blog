...
之前是写 Java + Spring Boot 的，感觉各个坑点的解决方案都相当成熟，自成体系，约定远远大于自定义，后来者维护代码，大部分的代码都是模板式的，所以很省心。
...
并不像 Spring Boot 自嵌了一个 Tomcat，它直接可以在生产环境中使用，Flask 需要借助 `uWsgi` 或者 Gunicorn 来实现生产环境的部署。
...
2. [https://docs.gunicorn.org/](https://docs.gunicorn.org/)
