...
不光是 shell 的子 shell 进程，其他程序（Python/Go/Java/MySQL/PostgreSQL 等等）作为当前 shell 进程的子进程，也可以通过这样的方式来传递环境变量。

---

## 参考

1. [https://www.cherryservers.com/blog/how-to-set-list-and-manage-linux-environment-variables](https://www.cherryservers.com/blog/how-to-set-list-and-manage-linux-environment-variables)
2. [https://wiki.archlinux.org/title/Environment\_variables](https://wiki.archlinux.org/title/Environment\_variables)
3. [https://www.runoob.com/linux/linux-shell-variable.html](https://www.runoob.com/linux/linux-shell-variable.html)
4. [https://www.digitalocean.com/community/tutorials/how-to-view-and-update-the-linux-path-environment-variable](https://www.digitalocean.com/community/tutorials/how-to-view-and-update-the-linux-path-environment-variable)
