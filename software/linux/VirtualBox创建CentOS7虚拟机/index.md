...
2020 年 11 月 12 日，CentOS 7 正式版推出该系列最终版本 CentOS 7.9.2009。
...
1. 安装好 Virtual Box 7：[https://www.virtualbox.org/wiki/Downloads](https://www.virtualbox.org/wiki/Downloads)
2. 下载好 CentOS 7.9.2009：[http://isoredirect.centos.org/centos/7/isos/x86_64/](http://isoredirect.centos.org/centos/7/isos/x86_64/)
...
* NAT 模式：虚拟机通过宿主机的网卡去通信，虚拟机依赖 PC 机上网，可以理解成虚拟机被包含在 PC 机中，对外还是只有宿主机一台电脑，网络上的其他设备无法直接访问虚拟机。

它们之间具体的差异和细节，可以参考以下文章：

1. [https://superuser.com/questions/227505/what-is-the-difference-between-nat-bridged-host-only-networking](https://superuser.com/questions/227505/what-is-the-difference-between-nat-bridged-host-only-networking)
2. [https://www.linkedin.com/advice/0/how-do-you-choose-between-nat-bridge-mode-your#:~:text=NAT%20mode%20is%20ideal%20if,network%2Dintensive%20applications%20or%20services](https://www.linkedin.com/advice/0/how-do-you-choose-between-nat-bridge-mode-your#:~:text=NAT%20mode%20is%20ideal%20if,network%2Dintensive%20applications%20or%20services).
...
1. [https://serverfault.com/questions/429014/what-is-the-relation-between-networkmanager-and-network-service-in-fedora-rhel-c](https://serverfault.com/questions/429014/what-is-the-relation-between-networkmanager-and-network-service-in-fedora-rhel-c)
2. [https://superuser.com/questions/482054/difference-between-etc-network-and-etc-networkmanager-in-ubuntu](https://superuser.com/questions/482054/difference-between-etc-network-and-etc-networkmanager-in-ubuntu)
3. [https://forums.centos.org/viewtopic.php?t=47598](https://forums.centos.org/viewtopic.php?t=47598)
4. [https://blog.csdn.net/wsyzxss/article/details/130596225](https://blog.csdn.net/wsyzxss/article/details/130596225)
...
wget [https://nginx.org/download/nginx-1.20.2.tar.gz](https://nginx.org/download/nginx-1.20.2.tar.gz)
...
1、配置过程：配置命令位于软件解压缩目录下（以 Nginx 为例）
...
1. [https://blog.51cto.com/u_15127625/2731486](https://blog.51cto.com/u_15127625/2731486)
2. [https://blog.csdn.net/shaoming314/article/details/123144325](https://blog.csdn.net/shaoming314/article/details/123144325)
...
本文所有的 rpm 包，均从该网站下载：[https://pkgs.org/](https://pkgs.org/)
...
perl 的下载地址：[https://rpmfind.net/linux/RPM/centos/7.9.2009/x86_64/Packages/perl-5.16.3-297.el7.x86_64.html](https://rpmfind.net/linux/RPM/centos/7.9.2009/x86_64/Packages/perl-5.16.3-297.el7.x86_64.html)

perl 需要的依赖很多：

![](./images/34.jpg)

依赖包可以从这个网站下载：[http://mirror.centos.org/centos/7/os/x86_64/Packages/](http://mirror.centos.org/centos/7/os/x86_64/Packages/)
...
具体细节可以参考：[https://www.xin3721.com/ArticleMySQL/mysql22645.html](https://www.xin3721.com/ArticleMySQL/mysql22645.html)
...
下载地址：[https://download.redis.io/releases/redis-5.0.0.tar.gz](https://download.redis.io/releases/redis-5.0.0.tar.gz)
...
Nginx 下载地址：[https://nginx.org/download/](https://nginx.org/download/)
...
1. [https://developers.redhat.com/products/openjdk/download](https://developers.redhat.com/products/openjdk/download)
2. [https://www.openlogic.com/openjdk-downloads](https://www.openlogic.com/openjdk-downloads)
3. [https://www.oracle.com/tw/java/technologies/javase/javase8-archive-downloads.html](https://www.oracle.com/tw/java/technologies/javase/javase8-archive-downloads.html)
4. [https://www.oracle.com/java/technologies/downloads/](https://www.oracle.com/java/technologies/downloads/)
...
[https://python.org/downloads/source/](https://python.org/downloads/source/)
...
编译需要依赖以下一些模块，由于本文之前已经安装了 gcc、MySQL、Nginx 等软件，部分依赖已经安装好了，没有安装的依赖也可以通过 `rpm -q 依赖名称` 来判断，然后在 [https://pkgs.org/](https://pkgs.org/) 中搜索并安装相应的 rpm 包，所以这里不再赘述这些依赖的安装过程：
...
Docker 下载地址：[https://download.docker.com/linux/centos/7/x86_64/stable/Packages/](https://download.docker.com/linux/centos/7/x86_64/stable/Packages/)
