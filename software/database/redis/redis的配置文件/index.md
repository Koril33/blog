...
每一个版本的配置文件原始文本，都可以在官网找到，比如 7.0 的配置文件：[https://raw.githubusercontent.com/redis/redis/7.0/redis.conf](https://raw.githubusercontent.com/redis/redis/7.0/redis.conf)
...
1. [https://redis.io/docs/latest/operate/oss_and_stack/management/config/](https://redis.io/docs/latest/operate/oss_and_stack/management/config/)
1. [https://redis.com.cn/redis-configuration.html](https://redis.com.cn/redis-configuration.html)
1. [https://dev.to/rijultp/understanding-redisconf-how-to-configure-your-redis-server-38lf](https://dev.to/rijultp/understanding-redisconf-how-to-configure-your-redis-server-38lf)
