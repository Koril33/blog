...
[pika](https://pika.readthedocs.io/en/stable/)是 AMQP 0-9-1（也就是 RabbitMQ 支持的协议）的纯 Python 实现。
...
1. [https://www.rabbitmq.com/tutorials](https://www.rabbitmq.com/tutorials)
