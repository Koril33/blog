...
Filebeat 提供了非常多的 input 类型：[https://www.elastic.co/docs/reference/beats/filebeat/configuration-filebeat-options#filebeat-input-types](https://www.elastic.co/docs/reference/beats/filebeat/configuration-filebeat-options#filebeat-input-types)

但文本聚焦于磁盘日志文件的读取，因此这里仅介绍 filestream 类型的 input（旧版本 7.x 之前，用的是 log 类型，filestream 是对旧版 log 类型的重构，性能更好，且解决了旧版中一些顽固的 inode 重用等问题）。
...
另一种是使用现成的轮子：[https://pypi.org/project/python-json-logger/](https://pypi.org/project/python-json-logger/)
...
使用时，参数可以是文本（JSON 字段对应 message），也可以是字典：
...
1. [https://www.elastic.co/beats/filebeat](https://www.elastic.co/beats/filebeat)
2. [https://www.elastic.co/docs/reference/beats/filebeat](https://www.elastic.co/docs/reference/beats/filebeat)
3. [https://www.elastic.co/docs/reference/beats/filebeat/how-filebeat-works](https://www.elastic.co/docs/reference/beats/filebeat/how-filebeat-works)
4. [https://nhairs.github.io/python-json-logger/latest/](https://nhairs.github.io/python-json-logger/latest/)
